...
input[12]="-login admin -password 00000 -role READ -resource A -ds 2015-12-31 -de 2016-12-31 -vol NOT_VALID"
...
for ((i = 0; i < 15; i++)); do
  ...
  java -cp ./lib/kotlinx-cli-0.2.1.jar:main.jar app.MainKt ${input[$i]}
